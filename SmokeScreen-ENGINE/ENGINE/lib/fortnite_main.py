...
def setup():
    ...
    print("[INFO] In-game X and Y axis sensitivity should be same")
    def prompt(str):
        valid_input = False
        while not valid_input:
            try:
                ...
                print("[!] Invalid Input. Make sure to enter only a number (e.g. 6.9)")
        return number
    ...
    print("[INFO] Your in-game targeting sensitivity must be same as your scoping sensitivity")
...
(Neural Network Aimbot)''', "green"))
    ...
    print(colored('To get full version of Lunar V2, visit https://gannonr.com/lunar OR join our discord: discord.gg/aiaimbot', "red"))
