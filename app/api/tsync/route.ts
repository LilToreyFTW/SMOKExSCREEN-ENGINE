...
// # ADDED: Final /api/tsync implementation used by ENGINE.exe
...
export async function POST(req: NextRequest) {
  ...
  const keys: { key_value: string; duration_type: string; duration_ms: number }[] = rawKeys
    .map((k: unknown) => {
...
// # ADDED: Original stub /api/tsync implementation kept for reference
// /**
